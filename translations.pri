TRANSLATIONS +=  translations/deepin-picker_ar.ts \
    ...
    translations/deepin-picker_fr.ts \
    translations/deepin-picker_he.ts \
    translations/deepin-picker_hr.ts \
    translations/deepin-picker_id.ts \
    translations/deepin-picker_it.ts \
    translations/deepin-picker_lt.ts \
    translations/deepin-picker_pt_BR.ts \
    translations/deepin-picker_ru.ts \
    translations/deepin-picker_sk.ts \
